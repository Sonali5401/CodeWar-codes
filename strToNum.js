...
// console.log(parse("twenty"))
// console.log(parse("zero"))
console.log(parse("two hundred forty-six"))
// console.log(parse("seven hundred eighty-three thousand nine hundred and nineteen"))